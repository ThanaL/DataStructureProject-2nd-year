...
Timer t1;
int m=0;
ArrayList<Final>list=new ArrayList<Final>();
    /**
     * Creates new form go
     */
    public go(final ArrayList<Final>list) {
         setUndecorated(true);
                initComponents();
...
if(m == 5){
        ...
        new Result(list).setVisible(true);   
        t1.stop();
dispose();
}
else 
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/wait.jpg"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 153, 204));
        jLabel1.setText(" Dear  Student!Wait 5 sec");
